...
var usaChart = dc.bubbleOverlay("#usa-map")
            .svg(d3.select("#usa-map svg g"));
...
d3.json("/data/us.json", function(error, us) {
  ...
  d3.json("/data/usa-laureates.json", function(error, data) {
    ...
    usaChart.width(600)
        ...
        data.forEach(function(laureate){
          ...
          if(coordinates !== null){
            usaChart.point(laureate.bornCity, coordinates[0], coordinates[1]);
          }
        });
        dc.renderAll();
